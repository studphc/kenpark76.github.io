...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) {
        ...
        Object m2067trySendImplMj0NB7M = conflatedBufferedChannel.m2067trySendImplMj0NB7M(e, true);
        if (m2067trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m2054exceptionOrNullimpl(m2067trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object m2067trySendImplMj0NB7M = conflatedBufferedChannel.m2067trySendImplMj0NB7M(e, true);
        if (!(m2067trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) m2067trySendImplMj0NB7M;
    ...
    public Object mo2039trySendJP2dKIU(E e) {
        return m2067trySendImplMj0NB7M(e, false);
    }

    /* renamed from: trySendImpl-Mj0NB7M  reason: not valid java name */
    private final Object m2067trySendImplMj0NB7M(E e, boolean z) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m2066trySendDropLatestMj0NB7M(e, z) : m2045trySendDropOldestJP2dKIU(e);
    }

    /* renamed from: trySendDropLatest-Mj0NB7M  reason: not valid java name */
    private final Object m2066trySendDropLatestMj0NB7M(E e, boolean z) {
        Function1<E, Unit> function1;
        UndeliveredElementException callUndeliveredElementCatchingException$default;
        Object mo2039trySendJP2dKIU = super.mo2039trySendJP2dKIU(e);
        if (ChannelResult.m2060isSuccessimpl(mo2039trySendJP2dKIU) || ChannelResult.m2058isClosedimpl(mo2039trySendJP2dKIU)) {
            return mo2039trySendJP2dKIU;
        }
    ...
    public void registerSelectForSend(SelectInstance<?> selectInstance, Object obj) {
        Object mo2039trySendJP2dKIU = mo2039trySendJP2dKIU(obj);
        if (!(mo2039trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo2039trySendJP2dKIU;
            selectInstance.selectInRegistrationPhase(Unit.INSTANCE);
        } else if (!(mo2039trySendJP2dKIU instanceof ChannelResult.Closed)) {
            throw new IllegalStateException("unreachable".toString());
        } else {
            ChannelResult.m2054exceptionOrNullimpl(mo2039trySendJP2dKIU);
