...
final class AudioFocusManager {
    ...
    private int requestAudioFocusV26() {
        ...
        if (audioFocusRequest == null || this.rebuildAudioFocusRequest) {
            if (audioFocusRequest == null) {
                ...
                m = Util$$ExternalSyntheticApiModelOutline0.m(this.focusGainToRequest);
            } else {
                Util$$ExternalSyntheticApiModelOutline0.m$1();
    ...
    public class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        public /* synthetic */ void m176x93d291e3(int i) {
        ...
        public void onAudioFocusChange(final int i) {
            this.eventHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.AudioFocusManager$AudioFocusListener$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AudioFocusManager.AudioFocusListener.this.m176x93d291e3(i);
                }
            });
        }
    }
