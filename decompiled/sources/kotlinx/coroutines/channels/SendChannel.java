...
public interface SendChannel<E> {
    ...
    Object mo2039trySendJP2dKIU(E e);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2039trySendJP2dKIU = sendChannel.mo2039trySendJP2dKIU(e);
            if (ChannelResult.m2060isSuccessimpl(mo2039trySendJP2dKIU)) {
                return true;
            }
            Throwable m2054exceptionOrNullimpl = ChannelResult.m2054exceptionOrNullimpl(mo2039trySendJP2dKIU);
