...
public final class NalUnitUtil {
    ...
    */
    ...
    public static H265SpsData parseH265SpsNalUnitPayload(byte[] bArr, int i, int i2) {
        ...
        if (parsableNalUnitBitArray.readBit()) {
            ...
            if (parsableNalUnitBitArray.readBit()) {
                ...
                if (parsableNalUnitBitArray.readBit()) {
                    ...
                    parsableNalUnitBitArray.skipBits(8);
                    i4 = ColorInfo.isoColorPrimariesToColorSpace(readBits8);
        ...
        return new H265SpsData(readBits2, readBit, readBits3, i9, readUnsignedExpGolombCodedInt2, readUnsignedExpGolombCodedInt9, readUnsignedExpGolombCodedInt10, iArr, readBits4, readUnsignedExpGolombCodedInt, i15, i3, f, i4, i5, i6);
    }
