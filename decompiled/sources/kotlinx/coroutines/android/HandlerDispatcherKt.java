...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m536constructorimpl = Result.m536constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m536constructorimpl = Result.m536constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m542isFailureimpl(m536constructorimpl) ? null : m536constructorimpl;
    }
    ...
    public static final Object awaitFrameSlowPath(Continuation<? super Long> continuation) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            Dispatchers.getMain().mo2095dispatch(cancellableContinuationImpl2.getContext(), new Runnable() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$awaitFrameSlowPath$lambda$3$$inlined$Runnable$1
