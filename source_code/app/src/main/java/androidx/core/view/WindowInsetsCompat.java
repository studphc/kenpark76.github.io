...
public class WindowInsetsCompat {
    ...
    private static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m101m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat) {
            super(windowInsetsCompat);
            WindowInsets.Builder m101m;
            WindowInsets windowInsets = windowInsetsCompat.toWindowInsets();
            if (windowInsets != null) {
                m101m = HalfKt$$ExternalSyntheticApiModelOutline0.m102m(windowInsets);
            } else {
                m101m = HalfKt$$ExternalSyntheticApiModelOutline0.m101m();
            }
            this.mPlatBuilder = m101m;
        }
