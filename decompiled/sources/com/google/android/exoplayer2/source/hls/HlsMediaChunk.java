...
public final class HlsMediaChunk extends MediaChunk {
    ...
    public static HlsMediaChunk createInstance(HlsExtractorFactory hlsExtractorFactory, DataSource dataSource, Format format, long j, HlsMediaPlaylist hlsMediaPlaylist, HlsChunkSource.SegmentBaseHolder segmentBaseHolder, Uri uri, List<Format> list, int i, Object obj, boolean z, TimestampAdjusterProvider timestampAdjusterProvider, HlsMediaChunk hlsMediaChunk, byte[] bArr, byte[] bArr2) {
        ...
        if (hlsMediaChunk != null) {
            ...
            boolean z8 = !(z7 || (isIndependent(segmentBaseHolder, hlsMediaPlaylist) && j2 >= hlsMediaChunk.endTimeUs));
            if (!z7 || hlsMediaChunk.extractorInvalidated) {
                i2 = i3;
            } else {
                i2 = i3;
                if (hlsMediaChunk.discontinuitySequenceNumber == i2) {
        ...
        return new HlsMediaChunk(hlsExtractorFactory, buildDataSource, build, format, z2, dataSource2, dataSpec, z3, uri, list, i, obj, j2, j3, segmentBaseHolder.mediaSequence, segmentBaseHolder.partIndex, !segmentBaseHolder.isPreload, i2, segmentBase.hasGapTag, z, timestampAdjusterProvider.getAdjuster(i2), segmentBase.drmInitData, hlsMediaChunkExtractor, id3Decoder, parsableByteArray, z4);
    }
