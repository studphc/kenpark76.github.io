    ...
    private final int trySelectInternal(Object obj, Object obj2) {
        ...
        while (true) {
            ...
            if (!(obj3 instanceof CancellableContinuation)) {
                ...
                if (Intrinsics.areEqual(obj3, symbol2) ? true : obj3 instanceof ClauseData) {
                    return 3;
                }
                ...
                } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(state$volatile$FU, this, obj3, CollectionsKt.plus((Collection<? extends Object>) obj3, obj))) {
                    return 1;
                }
            } else {
                SelectImplementation<R>.ClauseData findClause = findClause(obj);
