...
public final class TrackSelectionDialogBuilder {
    ...
    public TrackSelectionDialogBuilder(Context context, CharSequence charSequence, final Player player, final int i) {
        ...
        this.callback = new DialogCallback() { // from class: androidx.media3.ui.TrackSelectionDialogBuilder$$ExternalSyntheticLambda0
    ...
    private DialogInterface.OnClickListener setUpDialogView(View view) {
        ...
        return new DialogInterface.OnClickListener() { // from class: androidx.media3.ui.TrackSelectionDialogBuilder$$ExternalSyntheticLambda1
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i) {
                TrackSelectionDialogBuilder.this.m324xc121951d(trackSelectionView, dialogInterface, i);
            }
        };
    }
    ...
    public /* synthetic */ void m324xc121951d(TrackSelectionView trackSelectionView, DialogInterface dialogInterface, int i) {
