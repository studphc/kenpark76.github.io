...
public final class VideoFrameReleaseHelper {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:28:0x005c, code lost:
        if (java.lang.Math.abs(r0 - r8.surfaceMediaFrameRate) >= (r8.frameRateEstimator.isSynced() && (r8.frameRateEstimator.getMatchingFrameDurationSumNs() > androidx.media3.exoplayer.video.VideoFrameReleaseHelper.MINIMUM_MATCHING_FRAME_DURATION_FOR_HIGH_CONFIDENCE_NS ? 1 : (r8.frameRateEstimator.getMatchingFrameDurationSumNs() == androidx.media3.exoplayer.video.VideoFrameReleaseHelper.MINIMUM_MATCHING_FRAME_DURATION_FOR_HIGH_CONFIDENCE_NS ? 0 : -1)) >= 0 ? androidx.media3.exoplayer.video.VideoFrameReleaseHelper.MINIMUM_MEDIA_FRAME_RATE_CHANGE_FOR_UPDATE_HIGH_CONFIDENCE : 1.0f)) goto L26;
     */
    ...
    */
    private void updateSurfaceMediaFrameRate() {
        /*
            ...
            goto L73
        Lc:
            androidx.media3.exoplayer.video.FixedFrameRateEstimator r0 = r8.frameRateEstimator
        ...
        L24:
            ...
            if (r2 == 0) goto L61
            androidx.media3.exoplayer.video.FixedFrameRateEstimator r1 = r8.frameRateEstimator
        ...
        L61:
            ...
            goto L6c
        L64:
            androidx.media3.exoplayer.video.FixedFrameRateEstimator r2 = r8.frameRateEstimator
