    ...
    private static HlsMediaPlaylist parseMediaPlaylist(HlsMasterPlaylist hlsMasterPlaylist, HlsMediaPlaylist hlsMediaPlaylist, LineIterator lineIterator, String str) throws IOException {
        ...
        while (lineIterator.hasNext()) {
            ...
            if (next.startsWith(TAG_PLAYLIST_TYPE)) {
                ...
                segment2 = new HlsMediaPlaylist.Segment(parseStringAttr2, j10, j12, str11, str12);
                if (i6 != 0) {
                    j10 += j12;
                }
                str9 = str12;
                ...
                if (next.startsWith(TAG_TARGET_DURATION)) {
                    ...
                    if (next.startsWith(TAG_DEFINE)) {
                        ...
                        str7 = parseOptionalStringAttr(next, REGEX_MEDIA_TITLE, str6, hashMap2);
                        hlsMasterPlaylist2 = hlsMasterPlaylist;
                        j15 = (long) (parseDoubleAttr(next, REGEX_MEDIA_DURATION) * 1000000.0d);
                    } else {
                        if (next.startsWith(TAG_SKIP)) {
                            ...
                            while (i7 < i8) {
                                ...
                                if (j7 != hlsMediaPlaylist2.mediaSequence) {
                                    segment3 = segment3.copyWith(j17, (hlsMediaPlaylist2.discontinuitySequence - i3) + segment3.relativeDiscontinuitySequence);
                                }
                                arrayList3.add(segment3);
                                j17 += segment3.durationUs;
                                if (segment3.byteRangeLength != -1) {
                                    i = i8;
                                    j10 = segment3.byteRangeOffset + segment3.byteRangeLength;
                                } else {
                                    i = i8;
                                }
                                ...
                                String str18 = segment3.fullSegmentEncryptionKeyUri;
                                if (segment3.encryptionIV != null) {
                                    segment = segment4;
                                    if (segment3.encryptionIV.equals(Long.toHexString(j14))) {
                                        j14++;
                                        i7++;
                            ...
                            if (next.startsWith(TAG_KEY)) {
                                ...
                                if (next.startsWith(TAG_BYTERANGE)) {
                                    ...
                                    if (next.startsWith(TAG_PROGRAM_DATE_TIME)) {
                                        if (j6 == 0) {
                                            j6 = C.msToUs(Util.parseXsDateTime(next.substring(next.indexOf(58) + 1))) - j13;
                                        } else {
                                            hashMap = hashMap4;
                                            arrayList2 = arrayList3;
                                            part = part2;
                                        ...
                                        long parseOptionalLongAttr = parseOptionalLongAttr(next, REGEX_LAST_MSN, (j7 + arrayList3.size()) - (arrayList4.isEmpty() ? 1L : 0L));
                                        int parseOptionalIntAttr = parseOptionalIntAttr(next, REGEX_LAST_PART, j9 != -9223372036854775807L ? (arrayList4.isEmpty() ? ((HlsMediaPlaylist.Segment) Iterables.getLast(arrayList3)).parts : arrayList4).size() - 1 : -1);
                                        ...
                                        if (next.startsWith(TAG_PRELOAD_HINT)) {
                                            ...
                                            if (part3 == null && TYPE_PART.equals(parseStringAttr(next, REGEX_PRELOAD_HINT_TYPE, hashMap2))) {
                                                ...
                                                long j18 = j14;
                                                String segmentEncryptionIV = getSegmentEncryptionIV(j18, str13, str14);
                                                ...
                                                if (i10 == 0 || parseOptionalLongAttr3 != -1) {
                                                    part2 = new HlsMediaPlaylist.Part(parseStringAttr4, segment2, 0L, i5, j11, drmInitData3, str13, segmentEncryptionIV, i10 != 0 ? parseOptionalLongAttr2 : 0L, parseOptionalLongAttr3, false, false, true);
                                                } else {
                                                    part2 = part3;
                                                }
                                                hlsMasterPlaylist2 = hlsMasterPlaylist;
                                            ...
                                            if (next.startsWith(TAG_PART)) {
                                                String segmentEncryptionIV2 = getSegmentEncryptionIV(j, str13, str14);
                                                ...
                                                boolean z8 = z4;
                                                boolean parseOptionalBooleanAttribute = parseOptionalBooleanAttribute(next, REGEX_INDEPENDENT, false) | (z3 && arrayList4.isEmpty());
                                                ...
                                                arrayList4.add(new HlsMediaPlaylist.Part(parseStringAttr5, segment2, parseDoubleAttr, i5, j11, drmInitData3, str13, segmentEncryptionIV2, j16, j2, parseOptionalBooleanAttribute2, parseOptionalBooleanAttribute, false));
                                                j11 += parseDoubleAttr;
                                                if (i11 != 0) {
                                                    j16 += j2;
                                                }
                                                ...
                                                if (next.startsWith("#")) {
                                                    ...
                                                    String segmentEncryptionIV3 = getSegmentEncryptionIV(j, str13, str14);
                                                    j14 = j + 1;
                                                    ...
                                                    if (i12 == 0) {
                                                        ...
                                                        if (z7 && segment2 == null && segment5 == null) {
                                                            segment5 = new HlsMediaPlaylist.Segment(replaceVariableReferences, 0L, j10, null, null);
                                                    ...
                                                    HlsMediaPlaylist.Segment segment6 = new HlsMediaPlaylist.Segment(replaceVariableReferences, segment2 != null ? segment2 : segment5, str7, j15, i5, j13, drmInitData, str13, segmentEncryptionIV3, j3, j12, z6, arrayList4);
                                                    arrayList2 = arrayList7;
        ...
        return new HlsMediaPlaylist(i2, str, arrayList8, j5, j6, z9, i3, j7, i4, j8, j9, z3, z5, j6 != 0, drmInitData2, arrayList9, arrayList4, serverControl2, hashMap5);
    }
