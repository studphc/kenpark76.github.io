        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m1107contentEqualskV0jMPg(((UByteArray) t).m622unboximpl(), ((UByteArray) t2).m622unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m1105contentEqualsFGO6Aew(((UShortArray) t).m885unboximpl(), ((UShortArray) t2).m885unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m1106contentEqualsKJPZfPQ(((UIntArray) t).m701unboximpl(), ((UIntArray) t2).m701unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m1108contentEqualslec5QzE(((ULongArray) t).m780unboximpl(), ((ULongArray) t2).m780unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder sb, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                sb.append(UArraysKt.m1113contentToString2csIQuQ(uByteArray != null ? uByteArray.m622unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                sb.append(UArraysKt.m1115contentToStringd6D3K8(uShortArray != null ? uShortArray.m885unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                sb.append(UArraysKt.m1114contentToStringXUkPCBk(uIntArray != null ? uIntArray.m701unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                sb.append(UArraysKt.m1116contentToStringuLth9ew(uLongArray != null ? uLongArray.m780unboximpl() : null));
            } else {
