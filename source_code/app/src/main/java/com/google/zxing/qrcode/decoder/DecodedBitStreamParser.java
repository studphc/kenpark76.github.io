        ...
        while (true) {
            try {
                ...
                if (mode == Mode.TERMINATOR) {
                    return new DecoderResult(bArr, sb.toString(), arrayList.isEmpty() ? null : arrayList, errorCorrectionLevel != null ? errorCorrectionLevel.toString() : null, i2, i3, characterSetECI != null ? z2 ? 4 : z3 ? 6 : 2 : z2 ? 3 : z3 ? 5 : 1);
                }
                i = 1;
