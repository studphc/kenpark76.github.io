...
@Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0005\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u00002\f\u0010\u0003\u001a\b\u0012\u0004\u0012\u00020\u00020\u0001H\u008a@"}, d2 = {ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/channels/ChannelResult;", "", "result", "", "<anonymous>"}, k = 3, mv = {1, 9, 0})
...
final class FlowKt__DelayKt$sample$2$1$1 extends SuspendLambda implements Function2<ChannelResult<? extends Object>, Continuation<? super Unit>, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(ChannelResult<? extends Object> channelResult, Continuation<? super Unit> continuation) {
        return m2077invokeWpGqRn0(channelResult.m2062unboximpl(), continuation);
    }

    /* renamed from: invoke-WpGqRn0  reason: not valid java name */
    public final Object m2077invokeWpGqRn0(Object obj, Continuation<? super Unit> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ?? m2062unboximpl = ((ChannelResult) this.L$0).m2062unboximpl();
        Ref.ObjectRef<Object> objectRef = this.$lastValue;
        boolean z = m2062unboximpl instanceof ChannelResult.Failed;
        if (!z) {
            objectRef.element = m2062unboximpl;
        }
        ReceiveChannel<Unit> receiveChannel = this.$ticker;
        Ref.ObjectRef<Object> objectRef2 = this.$lastValue;
        if (z) {
            Throwable m2054exceptionOrNullimpl = ChannelResult.m2054exceptionOrNullimpl(m2062unboximpl);
            if (m2054exceptionOrNullimpl != null) {
                throw m2054exceptionOrNullimpl;
            }
