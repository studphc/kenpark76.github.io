...
public final class RtspMessageChannel implements Closeable {
    ...
    public final class Sender implements Closeable {
        ...
        public void send(final List<String> list) {
            ...
            this.senderThreadHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.rtsp.RtspMessageChannel$Sender$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    RtspMessageChannel.Sender.this.m263x8c7d4ead(convertMessageToByteArray, list);
                }
            });
        }
        ...
        public /* synthetic */ void m263x8c7d4ead(byte[] bArr, List list) {
            try {
        ...
        public void close() {
            ...
            handler.post(new Runnable() { // from class: androidx.media3.exoplayer.rtsp.RtspMessageChannel$Sender$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    handlerThread.quit();
                }
