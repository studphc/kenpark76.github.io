...
public class MatroskaExtractor implements Extractor {
    ...
    public static ExtractorsFactory newFactory(final SubtitleParser.Factory factory) {
        return new ExtractorsFactory() { // from class: androidx.media3.extractor.mkv.MatroskaExtractor$$ExternalSyntheticLambda1
            @Override // androidx.media3.extractor.ExtractorsFactory
            public final Extractor[] createExtractors() {
    ...
    */
    protected void binaryElement(int r23, int r24, androidx.media3.extractor.ExtractorInput r25) throws java.io.IOException {
        /*
    ...
    public static final class Track {
        ...
        public void initializeOutput(ExtractorOutput extractorOutput, int i) throws ParserException {
            ...
            if (MimeTypes.isAudio(str5)) {
                ...
                builder.setWidth(this.width).setHeight(this.height).setPixelWidthHeightRatio(f).setRotationDegrees(i4).setProjectionData(this.projectionData).setStereoMode(this.stereoMode).setColorInfo(build);
                i3 = 2;
            ...
            Format build2 = builder.setId(i).setSampleMimeType(str5).setMaxInputSize(i2).setLanguage(this.language).setSelectionFlags(i9).setInitializationData(singletonList).setCodecs(str).setDrmInitData(this.drmInitData).build();
