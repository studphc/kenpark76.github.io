...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        ...
        if (mo2039trySendJP2dKIU instanceof ChannelResult.Failed) {
            ...
            return ((ChannelResult) runBlocking$default).m2062unboximpl();
        }
        Unit unit = (Unit) mo2039trySendJP2dKIU;
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) {
        if (ChannelResult.m2060isSuccessimpl(sendChannel.mo2039trySendJP2dKIU(obj))) {
            return;
        }
