...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public void mo2096scheduleResumeAfterDelay(long j, CancellableContinuation<? super Unit> cancellableContinuation) {
    ...
    */
    public long processNextEvent() {
        ...
        L9:
            ...
            if (r3 != 0) goto L58
            kotlinx.coroutines.AbstractTimeSource r3 = kotlinx.coroutines.AbstractTimeSourceKt.access$getTimeSource$p()
            if (r3 == 0) goto L26
            long r3 = r3.nanoTime()
            goto L2a
        L26:
        ...
        L2a:
            ...
            monitor-enter(r5)
            kotlinx.coroutines.internal.ThreadSafeHeapNode r6 = r5.firstImpl()     // Catch: java.lang.Throwable -> L55
            r7 = 0
            if (r6 != 0) goto L37
            monitor-exit(r5)
            goto L50
        L37:
            kotlinx.coroutines.EventLoopImplBase$DelayedTask r6 = (kotlinx.coroutines.EventLoopImplBase.DelayedTask) r6     // Catch: java.lang.Throwable -> L55
            boolean r8 = r6.timeToExecute(r3)     // Catch: java.lang.Throwable -> L55
            r9 = 0
            if (r8 == 0) goto L47
            java.lang.Runnable r6 = (java.lang.Runnable) r6     // Catch: java.lang.Throwable -> L55
            boolean r6 = r10.enqueueImpl(r6)     // Catch: java.lang.Throwable -> L55
            goto L48
        L47:
            r6 = 0
        L48:
            if (r6 == 0) goto L4f
            kotlinx.coroutines.internal.ThreadSafeHeapNode r6 = r5.removeAtImpl(r9)     // Catch: java.lang.Throwable -> L55
            r7 = r6
        L4f:
            monitor-exit(r5)
        L50:
    ...
    public final void mo2095dispatch(CoroutineContext coroutineContext, Runnable runnable) {
        enqueue(runnable);
    }
