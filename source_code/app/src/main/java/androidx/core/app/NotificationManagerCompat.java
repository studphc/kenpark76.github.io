    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            for (NotificationChannel notificationChannel : Api26Impl.getNotificationChannels(this.mNotificationManager)) {
                NotificationChannel m0m = SearchView$$ExternalSyntheticApiModelOutline0.m0m((Object) notificationChannel);
                if (!collection.contains(Api26Impl.getId(m0m)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(m0m)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(m0m));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            for (NotificationChannelGroup notificationChannelGroup : getNotificationChannelGroups()) {
                NotificationChannelGroup m1m = SearchView$$ExternalSyntheticApiModelOutline0.m1m((Object) notificationChannelGroup);
                if (Api26Impl.getId(m1m).equals(str)) {
                    return m1m;
                }
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                for (NotificationChannel notificationChannel : notificationChannels) {
                    arrayList.add(new NotificationChannelCompat(SearchView$$ExternalSyntheticApiModelOutline0.m0m((Object) notificationChannel)));
                }
                return arrayList;
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                for (NotificationChannelGroup notificationChannelGroup : notificationChannelGroups) {
                    NotificationChannelGroup m1m = SearchView$$ExternalSyntheticApiModelOutline0.m1m((Object) notificationChannelGroup);
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(m1m));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(m1m, notificationChannels));
                    }
                }
                return arrayList;
            }
