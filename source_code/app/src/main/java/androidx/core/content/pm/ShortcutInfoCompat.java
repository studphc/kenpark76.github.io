...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo build;
        SearchView$$ExternalSyntheticApiModelOutline0.m12m();
        shortLabel = SearchView$$ExternalSyntheticApiModelOutline0.m3m(this.mContext, this.mId).setShortLabel(this.mLabel);
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo shortcutInfo : list) {
            arrayList.add(new Builder(context, SearchView$$ExternalSyntheticApiModelOutline0.m4m((Object) shortcutInfo)).build());
        }
        return arrayList;
    }
