    ...
    private static List<StackTraceElement> jlaStackTrace(final Throwable t) {
        ...
        return new AbstractList<StackTraceElement>() { // from class: com.google.common.base.Throwables.1
            ...
            public StackTraceElement get(int n) {
                return (StackTraceElement) Throwables.invokeAccessibleNonThrowingMethod((Method) j$.util.Objects.requireNonNull(Throwables.getStackTraceElementMethod), j$.util.Objects.requireNonNull(Throwables.jla), t, Integer.valueOf(n));
            }

            @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
            public int size() {
                return ((Integer) Throwables.invokeAccessibleNonThrowingMethod((Method) j$.util.Objects.requireNonNull(Throwables.getStackTraceDepthMethod), j$.util.Objects.requireNonNull(Throwables.jla), t)).intValue();
            }
        };
    }
