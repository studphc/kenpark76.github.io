...
public class AsynchronousMediaCodecBufferEnqueuer implements MediaCodecBufferEnqueuer {
    ...
    private static void copy(CryptoInfo cryptoInfo, MediaCodec.CryptoInfo cryptoInfo2) {
        ...
        if (Util.SDK_INT >= 24) {
            FrameworkMediaDrm$$ExternalSyntheticApiModelOutline0.m238m();
            cryptoInfo2.setPattern(Util$$ExternalSyntheticApiModelOutline0.m(cryptoInfo.encryptedBlocks, cryptoInfo.clearBlocks));
        }
    }
