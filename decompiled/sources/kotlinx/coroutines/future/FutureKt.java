...
public final class FutureKt {
    ...
    public static final <T> CompletableFuture<T> future(CoroutineScope coroutineScope, CoroutineContext coroutineContext, CoroutineStart coroutineStart, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2) {
        ...
        CompletableFuture<T> m2134m = Reflection$Java8$$ExternalSyntheticApiModelOutline0.m2134m();
        CompletableFutureCoroutine completableFutureCoroutine = new CompletableFutureCoroutine(newCoroutineContext, m2134m);
        m2134m.handle((BiFunction) completableFutureCoroutine);
    ...
    public static final <T> CompletableFuture<T> asCompletableFuture(final Deferred<? extends T> deferred) {
        final CompletableFuture<T> m2134m = Reflection$Java8$$ExternalSyntheticApiModelOutline0.m2134m();
        setupCancellation(deferred, m2134m);
        deferred.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt$asCompletableFuture$1
            ...
            public final void invoke2(Throwable th) {
                try {
                    m2134m.complete(deferred.getCompleted());
                } catch (Throwable th2) {
                    m2134m.completeExceptionally(th2);
                }
            }
        });
        return m2134m;
    ...
    public static final CompletableFuture<Unit> asCompletableFuture(Job job) {
        final CompletableFuture<Unit> m2134m = Reflection$Java8$$ExternalSyntheticApiModelOutline0.m2134m();
        setupCancellation(job, m2134m);
        job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: kotlinx.coroutines.future.FutureKt$asCompletableFuture$2
            ...
            public final void invoke2(Throwable th) {
                if (th == null) {
                    m2134m.complete(Unit.INSTANCE);
                } else {
                    m2134m.completeExceptionally(th);
                }
            }
        });
        return m2134m;
            ...
            */
            public final java.lang.Object invoke2(T r2, java.lang.Throwable r3) {
                ...
                L9:
                    ...
                    boolean r0 = retrofit2.Reflection$Java8$$ExternalSyntheticApiModelOutline0.m$1(r3)     // Catch: java.lang.Throwable -> L2a
                    if (r0 == 0) goto L16
                    java.util.concurrent.CompletionException r0 = retrofit2.Reflection$Java8$$ExternalSyntheticApiModelOutline0.m2135m(r3)     // Catch: java.lang.Throwable -> L2a
                    goto L17
                L16:
                    r0 = 0
                L17:
                    if (r0 == 0) goto L21
                    java.lang.Throwable r0 = retrofit2.Reflection$Java8$$ExternalSyntheticApiModelOutline0.m(r0)     // Catch: java.lang.Throwable -> L2a
                    if (r0 != 0) goto L20
                    goto L21
                L20:
                    r3 = r0
