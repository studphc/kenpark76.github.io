...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    public DefaultTimeBar(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2, int i2) {
        ...
        this.stopScrubbingRunnable = new Runnable() { // from class: androidx.media3.ui.DefaultTimeBar$$ExternalSyntheticLambda1
            ...
            public final void run() {
                DefaultTimeBar.this.m309lambda$new$0$androidxmedia3uiDefaultTimeBar();
            }
        };
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.media3.ui.DefaultTimeBar$$ExternalSyntheticLambda2
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator2) {
                DefaultTimeBar.this.m310lambda$new$1$androidxmedia3uiDefaultTimeBar(valueAnimator2);
            }
        });
    ...
    public /* synthetic */ void m309lambda$new$0$androidxmedia3uiDefaultTimeBar() {
        stopScrubbing(false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: lambda$new$1$androidx-media3-ui-DefaultTimeBar  reason: not valid java name */
    public /* synthetic */ void m310lambda$new$1$androidxmedia3uiDefaultTimeBar(ValueAnimator valueAnimator) {
