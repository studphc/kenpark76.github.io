...
public class AccessibilityNodeInfoCompat {
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public TouchDelegateInfoCompat(Map<Region, View> map) {
            if (Build.VERSION.SDK_INT >= 29) {
                this.mInfo = FragmentUtil$$ExternalSyntheticApiModelOutline0.m((Map) map);
            } else {
                this.mInfo = null;
            }
        }
        ...
        */
        public androidx.core.view.accessibility.AccessibilityNodeInfoCompat getTargetForRegion(android.graphics.Region r3) {
            /*
                ...
                android.view.accessibility.AccessibilityNodeInfo r3 = androidx.leanback.app.FragmentUtil$$ExternalSyntheticApiModelOutline0.m(r0, r3)
                if (r3 == 0) goto L13
    ...
    */
    public androidx.core.view.accessibility.AccessibilityNodeInfoCompat.TouchDelegateInfoCompat getTouchDelegateInfo() {
        /*
            ...
            android.view.accessibility.AccessibilityNodeInfo$TouchDelegateInfo r0 = androidx.leanback.app.FragmentUtil$$ExternalSyntheticApiModelOutline0.m128m(r0)
            if (r0 == 0) goto L14
    ...
    public static class Api34Impl {
        ...
        public static long getMinDurationBetweenContentChangeMillis(AccessibilityNodeInfo accessibilityNodeInfo) {
            return AccessibilityNodeInfoCompat$Api34Impl$$ExternalSyntheticAPIConversion0.m(accessibilityNodeInfo).toMillis();
        }

        public static void setMinDurationBetweenContentChangeMillis(AccessibilityNodeInfo accessibilityNodeInfo, long j) {
            AccessibilityNodeInfoCompat$Api34Impl$$ExternalSyntheticAPIConversion0.m(accessibilityNodeInfo, Duration.ofMillis(j));
        }
