...
public final class HlsMediaSource extends BaseMediaSource implements HlsPlaylistTracker.PrimaryPlaylistListener {
    ...
    public static final class Factory implements MediaSourceFactory {
        ...
        public HlsMediaSource createMediaSource(MediaItem mediaItem) {
            ...
            z = (!mediaItem2.playbackProperties.streamKeys.isEmpty() || list.isEmpty()) ? false : false;
            if (z2 && z) {
    ...
    public void onPrimaryPlaylistRefreshed(HlsMediaPlaylist hlsMediaPlaylist) {
        ...
        if (this.playlistTracker.isLive()) {
            ...
            if (hlsMediaPlaylist.segments.isEmpty()) {
                j = j3 == -9223372036854775807L ? 0L : j3;
            } else {
                j = getWindowDefaultStartPosition(hlsMediaPlaylist, liveEdgeOffsetUs);
            }
            singlePeriodTimeline = new SinglePeriodTimeline(j2, usToMs, -9223372036854775807L, j4, hlsMediaPlaylist.durationUs, initialStartTimeUs, j, true, !hlsMediaPlaylist.hasEndTag, (Object) hlsManifest, this.mediaItem, this.liveConfiguration);
        } else {
            singlePeriodTimeline = new SinglePeriodTimeline(j2, usToMs, -9223372036854775807L, hlsMediaPlaylist.durationUs, hlsMediaPlaylist.durationUs, 0L, j3 == -9223372036854775807L ? 0L : j3, true, false, (Object) hlsManifest, this.mediaItem, (MediaItem.LiveConfiguration) null);
        }
