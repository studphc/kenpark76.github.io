    ...
    */
    ...
    public static DtsHeader parseDtsHdHeader(byte[] bArr) throws ParserException {
        ...
        if (readBit) {
            ...
            i4 = normalizedFrame.readBits(8) + 1;
            i5 = i10;
        } else {
            i4 = -1;
            i5 = C.RATE_UNSET_INT;
        ...
        return new DtsHeader("audio/vnd.dts.hd;profile=lbr", i4, i5, readBits2, j, 0);
    }
    ...
    public static DtsHeader parseDtsUhdHeader(byte[] bArr, AtomicInteger atomicInteger) throws ParserException {
        ...
        return new DtsHeader(MimeTypes.AUDIO_DTS_X, 2, i, parseUnsignedVarInt + i5 + (atomicInteger.get() != 0 ? parseUnsignedVarInt(normalizedFrame, UHD_AUDIO_CHUNK_SIZE_LENGTH_TABLE, true) : 0), j, 0);
    }
