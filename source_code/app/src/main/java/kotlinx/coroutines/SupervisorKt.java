...
public final class SupervisorKt {
    ...
    public static final /* synthetic */ Job m2034SupervisorJob(Job job) {
        return SupervisorJob(job);
    }

    /* renamed from: SupervisorJob$default */
    public static /* synthetic */ Job m2035SupervisorJob$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m2034SupervisorJob(job);
    }
