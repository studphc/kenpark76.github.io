...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return HalfKt$$ExternalSyntheticApiModelOutline0.m97m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
        ...
        public static Pair<ContentInfo, ContentInfo> partition(ContentInfo contentInfo, final java.util.function.Predicate<ClipData.Item> predicate) {
            ...
            Pair<ClipData, ClipData> partition = ContentInfoCompat.partition(clip, new Predicate() { // from class: androidx.core.view.ContentInfoCompat$Api31Impl$$ExternalSyntheticLambda0
                ...
                public final boolean test(Object obj) {
                    return java.util.function.Predicate.this.test((ClipData.Item) obj);
                }
            });
            if (partition.first == null) {
    ...
    public static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = HalfKt$$ExternalSyntheticApiModelOutline0.m97m(Preconditions.checkNotNull(contentInfo));
        }
    ...
    private static final class BuilderCompat31Impl implements BuilderCompat {
        ...
        BuilderCompat31Impl(ContentInfoCompat contentInfoCompat) {
            HalfKt$$ExternalSyntheticApiModelOutline0.m108m();
            this.mPlatformBuilder = HalfKt$$ExternalSyntheticApiModelOutline0.m96m(contentInfoCompat.toContentInfo());
        }
