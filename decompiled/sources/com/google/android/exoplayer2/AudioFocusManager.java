...
final class AudioFocusManager {
    ...
    private int requestAudioFocusV26() {
        ...
        if (audioFocusRequest == null || this.rebuildAudioFocusRequest) {
            if (audioFocusRequest == null) {
                ...
                m = Util$$ExternalSyntheticApiModelOutline0.m(this.focusGain);
            } else {
                Util$$ExternalSyntheticApiModelOutline0.m$1();
                m = Util$$ExternalSyntheticApiModelOutline0.m(this.audioFocusRequest);
            }
            boolean willPauseWhenDucked2 = willPauseWhenDucked();
            audioAttributes = m.setAudioAttributes(((AudioAttributes) Assertions.checkNotNull(this.audioAttributes)).getAudioAttributesV21());
    ...
    public class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        public /* synthetic */ void m364xa83e850b(int i) {
        ...
        public void onAudioFocusChange(final int i) {
            this.eventHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.AudioFocusManager$AudioFocusListener$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    AudioFocusManager.AudioFocusListener.this.m364xa83e850b(i);
                }
            });
        }
    }
