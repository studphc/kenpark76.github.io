...
public final class MediaMetricsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    public static MediaMetricsListener create(Context context) {
        ...
        MediaMetricsManager m159m = Util$$ExternalSyntheticApiModelOutline0.m159m(context.getSystemService("media_metrics"));
        if (m159m == null) {
            return null;
        }
        createPlaybackSession = m159m.createPlaybackSession();
    ...
    public void onSessionActive(AnalyticsListener.EventTime eventTime, String str) {
        ...
        if (eventTime.mediaPeriodId == null || !eventTime.mediaPeriodId.isAd()) {
            ...
            playerName = Util$$ExternalSyntheticApiModelOutline0.m162m().setPlayerName(MediaLibraryInfo.TAG);
    ...
    private void maybeUpdateMetricsBuilderValues(Player player, AnalyticsListener.Events events) {
        ...
        if (events.contains(2) && this.metricsBuilder != null && (drmInitData = getDrmInitData(player.getCurrentTracks().getGroups())) != null) {
            Util$$ExternalSyntheticApiModelOutline0.m163m(Util.castNonNull(this.metricsBuilder)).setDrmType(getDrmType(drmInitData));
        }
    ...
    private void maybeReportPlaybackError(long j) {
        ...
        timeSinceCreatedMillis = Util$$ExternalSyntheticApiModelOutline0.m161m().setTimeSinceCreatedMillis(j - this.startTimeMs);
    ...
    private void maybeReportNetworkChange(long j) {
        ...
        if (networkType2 != this.currentNetworkType) {
            ...
            PlaybackSession playbackSession = this.playbackSession;
            networkType = Util$$ExternalSyntheticApiModelOutline0.m160m().setNetworkType(networkType2);
    ...
    private void maybeReportPlaybackStateChange(Player player, AnalyticsListener.Events events, long j) {
        ...
        if (this.currentPlaybackState != resolveNewPlaybackState) {
            ...
            this.reportedEventsForCurrentSession = true;
            PlaybackSession playbackSession = this.playbackSession;
            state = Util$$ExternalSyntheticApiModelOutline0.m164m().setState(this.currentPlaybackState);
    ...
    private void reportTrackChangeEvent(int i, long j, Format format, int i2) {
        ...
        timeSinceCreatedMillis = Util$$ExternalSyntheticApiModelOutline0.m165m(i).setTimeSinceCreatedMillis(j - this.startTimeMs);
        if (format != null) {
        ...
        if (!(th instanceof IOException)) {
            ...
            if (z3 || (th instanceof UdpDataSource.UdpDataSourceException)) {
                ...
                if (th instanceof DrmSession.DrmSessionException) {
                    ...
                    } else if (Util.SDK_INT >= 23 && Util$$ExternalSyntheticApiModelOutline0.m170m((Object) th2)) {
