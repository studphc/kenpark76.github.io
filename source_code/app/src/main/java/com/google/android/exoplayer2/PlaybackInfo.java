...
public final class PlaybackInfo {
    ...
    public static PlaybackInfo createDummy(TrackSelectorResult trackSelectorResult) {
        ...
        return new PlaybackInfo(timeline, mediaPeriodId, -9223372036854775807L, 1, null, false, TrackGroupArray.EMPTY, trackSelectorResult, ImmutableList.of(), mediaPeriodId, false, 0, PlaybackParameters.DEFAULT, 0L, 0L, 0L, false, false);
    }
