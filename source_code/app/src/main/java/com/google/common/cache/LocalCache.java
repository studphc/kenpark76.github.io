...
public class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, j$.util.concurrent.ConcurrentMap {
    ...
    public static class Segment<K, V> extends ReentrantLock {
        ...
        ListenableFuture<V> loadAsync(final K key, final int hash, final LoadingValueReference<K, V> loadingValueReference, CacheLoader<? super K, V> loader) {
            ...
            loadFuture.addListener(new Runnable() { // from class: com.google.common.cache.LocalCache$Segment$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    LocalCache.Segment.this.m448lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(key, hash, loadingValueReference, loadFuture);
                }
        ...
        public /* synthetic */ void m448lambda$loadAsync$0$comgooglecommoncacheLocalCache$Segment(Object obj, int i, LoadingValueReference loadingValueReference, ListenableFuture listenableFuture) {
            try {
    ...
    public static class LoadingValueReference<K, V> implements ValueReference<K, V> {
            ...
            try {
                ...
                return Futures.transform(reload, new com.google.common.base.Function() { // from class: com.google.common.cache.LocalCache$LoadingValueReference$$ExternalSyntheticLambda0
                    ...
                    public final Object apply(Object obj) {
                        return LocalCache.LoadingValueReference.this.m447x59597480(obj);
                    }
                }, MoreExecutors.directExecutor());
            } catch (Throwable th) {
        ...
        public /* synthetic */ Object m447x59597480(Object obj) {
            set(obj);
            return obj;
        }
